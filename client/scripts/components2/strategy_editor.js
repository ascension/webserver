define(['lib/react', '../engine-controller', '../strategies/strategies', '../lib/lodash', '../lib/clib'], function(React, EngineController, Strategies, _, Clib){
    var D = React.DOM;
    ...
    return React.createClass({
        ...
        runStrategy: function() {
            this.engineController = new EngineController(this.props.engine, this.state.script);
